...
import com.example.DATN2025.dto.BillReturn.*;
import com.example.DATN2025.repository.BillDetailRepository;
import com.example.DATN2025.repository.BillRepository;
import com.example.DATN2025.service.BillReturnService;
...
public class BillReturnController {
    ...
    // 👉 Thêm đoạn này để khi click vào menu "Quản lý hóa đơn" (/admin-only/bill)
    //    nó sẽ tự động chuyển hướng đến trang đúng (/admin/bill-list)
    @GetMapping("/admin-only/bill")
    public String redirectToBillList() {
