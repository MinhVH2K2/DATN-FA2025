...
public class FileUploadUtil {
    ...
    public static String saveFile(String uploadDir, String fileName, MultipartFile multipartFile) throws IOException {
        // ✅ Luôn tính đường dẫn tuyệt đối trong project (DATN2025)
        String projectDir = System.getProperty("user.dir"); // => ví dụ: D:/Projects/DATN2025
        Path uploadPath = Paths.get(projectDir, uploadDir); // => D:/Projects/DATN2025/uploads
